...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class TitanFPSController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (CrossPlatformInputManager.GetButtonDown("Jump") && Input.GetKey(KeyCode.W))
            {
                StartCoroutine("DashForward");
            }

            if (CrossPlatformInputManager.GetButtonDown("Jump") && Input.GetKey(KeyCode.A))
            {
                StartCoroutine("DashLeft");
            }

            if (CrossPlatformInputManager.GetButtonDown("Jump") && Input.GetKey(KeyCode.D))
            {
                StartCoroutine("DashRight");
            }

            if (CrossPlatformInputManager.GetButtonDown("Jump") && Input.GetKey(KeyCode.S))
            {
        ...
        {
            m_RigidBody.AddForce(cam.transform.forward * 30, ForceMode.VelocityChange);
        ...
        {
            m_RigidBody.AddForce((cam.transform.right * -1) * 30, ForceMode.VelocityChange);
            yield return new WaitForSeconds(0.75f);
            m_RigidBody.velocity = Vector3.zero;
        }
        ...
        {
            m_RigidBody.AddForce(cam.transform.right * 30, ForceMode.VelocityChange);
            yield return new WaitForSeconds(0.75f);
            m_RigidBody.velocity = Vector3.zero;
        }
